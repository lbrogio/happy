		...
		<ScrollView style={styles.container}>
			...
			<View style={styles.detailsContainer}>
				...
				<RectButton style={styles.contactButton}
					onPress={() => Linking.canOpenURL(`whatsapp://send?text=Olá,%20${orphanage.name},%20estou%20entrando%20em%20contato%20via%20Happy!%20:D`).then(supported => {
						if (supported) {
							return Linking.openURL(
								`whatsapp://send?phone=${orphanage.celphone}&text=Olá,%20${orphanage.name},%20estou%20entrando%20em%20contato%20via%20Happy!%20:D`
							);
						} else {
							return Linking.openURL(
								""
