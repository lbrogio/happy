...
import OprhanageData from './pages/CreateOrphanage/OrphanageData';
    ...
    return (
        <NavigationContainer>
            <Navigator screenOptions={{ headerShown: false, cardStyle: { backgroundColor: '#F2F3F5'} }}>
                ...
                <Screen name="OrphanageData" component={OprhanageData}  options={{ headerShown: true, header: () => <Header title="Informe os dados" />}} />
            </Navigator>
        </NavigationContainer>
    )
}